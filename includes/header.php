...
<body>
<header class="topbar">
<div class="header-logo"><a href="/mossrental/"><img src="assets/images/logo.png" alt="Company Logo"></a></div>
<div><h1><?= e(APP_NAME) ?></h1><p>Checkout hours: <?= e(checkout_open_time()->format('g:i A')) ?> to <?= e(checkout_cutoff_label()) ?>. Returnable inventory is due by <?= e(return_due_label()) ?>.</p></div>
<nav>
<a class="<?= $current==='index.php'?'active':'' ?>" href="index.php">Dashboard</a>
<a class="<?= in_array($current,['inventory.php','inventory_adjust.php'],true)?'active':'' ?>" href="inventory.php">Inventory</a>
...
<a class="<?= $current==='accessories.php'?'active':'' ?>" href="accessories.php">Supplies</a>
...
<span class="user-chip"><?= e(current_user()['full_name']??'') ?></span><a href="logout.php">Log Out</a>
</nav></header>
<main class="container">
<?php foreach(consume_flashes() as $item): ?><div class="alert <?= e($item['type']) ?>"><?= e($item['message']) ?></div><?php endforeach; ?>
